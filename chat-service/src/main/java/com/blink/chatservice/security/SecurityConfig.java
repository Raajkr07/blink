        ...
        http
                ...
                .headers(headers -> headers
                        ...
                        .contentSecurityPolicy(csp -> csp
                                .policyDirectives("default-src 'self' https://challenges.cloudflare.com; script-src 'self' 'unsafe-inline' 'unsafe-eval' blob: https://api.blinxai.me https://challenges.cloudflare.com https://static.cloudflareinsights.com; style-src 'self' 'unsafe-inline' https://challenges.cloudflare.com; img-src 'self' data: https:; font-src 'self' data: https://r2cdn.perplexity.ai; frame-src 'self' https://challenges.cloudflare.com; frame-ancestors 'self' https://blinxai.me https://www.blinxai.me https://blinx-app.netlify.app; worker-src 'self' blob:; connect-src 'self' ws: wss: https: https://api.blinxai.me https://challenges.cloudflare.com;")
                        )
                )

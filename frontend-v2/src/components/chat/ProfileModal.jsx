    ...
    return (
        ...
        >
                    ...
                    <div className="space-y-4 py-4">
                        ...
                        <div className="space-y-1.5">
                            {filteredSearchResults.map((user) => (
                                <div key={user.id} className="flex items-center gap-3 p-3 rounded-xl bg-white/2 border border-white/5 hover:border-white/10 transition-all">
                    ...
                    <div className="space-y-5 py-4">
                        ...
                        <div className="flex flex-col items-center text-center gap-2">
                            <div className="relative mb-1">
                                ...
                                />
                                {displayData?.online && (
                                    <div className="absolute bottom-1 right-1 w-4 h-4 bg-green-500 border-3 border-background rounded-full" />
                                )}
                            </div>
                        ...
                        <div className="space-y-3">
                            {displayData?.bio && (
                                <div className="rounded-2xl bg-white/3 border border-white/5 p-4">
                                    <h3 className="text-[10px] uppercase font-semibold tracking-wider text-gray-500 mb-2">About</h3>
                                    <p className="text-sm text-gray-300 leading-relaxed">{displayData.bio}</p>
                                </div>
                            )}
                            ...
                            {isGroup && groupParticipants && (
                                <div className="rounded-2xl bg-white/3 border border-white/5 p-4 space-y-3">
                                    <div className="flex items-center justify-between">
                                        <h3 className="text-[10px] uppercase font-semibold tracking-wider text-gray-500">Members ({groupParticipants.length})</h3>
                                        {isAdmin && (
                                            <Button
                                                variant="ghost"
                                                size="sm"
            ...
            <ModalFooter>
                {isEditing ? (
                    <>
                        <Button variant="ghost" onClick={() => setIsEditing(false)} className="text-xs font-medium text-gray-400">Cancel</Button>
                    ...
                    <Button variant="ghost" onClick={() => setShowAddMember(false)} className="text-xs font-medium text-gray-400 w-full">Back to Profile</Button>
                ) : (
                    <>
                        {isGroup ? (
                            <>
